...
<div id="content">
  ...
  <tr>
    <td colspan="2" align="left" valign="top"><p><strong>Destination gocek and fethiye bay </strong></p>
      <p>To book your cruise holiday you need to provide a deposit of a third of the total value. To make this easier we have provided payment buttons online. If you wish to pay by cheque or another means please contact us for information.</p>
...
<input type="hidden" name="hosted_button_id" value="UACAP79FB24DW">
<table>
...
Daily price £450  (&euro;525))</td>
          <td width="47%" align="right"><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="HAK2TVQNA5NYE">
<table>
<tr><td><input type="hidden" name="on0" value="Please Specify the Dates">Please Specify the Dates</td>
...
Daily price £325 (&euro;380)</td>
          <td width="47%" align="right"><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="WLNS6FX2CGBWG">
<table>
<tr><td><input type="hidden" name="on0" value="Please Specify the Dates">Please Specify the Dates</td>
